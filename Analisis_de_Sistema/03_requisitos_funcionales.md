...
Los requisitos funcionales describen las funciones que el sistema debe proporcionar a los usuarios, de acuerdo con las historias de usuario definidas previamente.
...
| RF05 | El sistema debe permitir generar un pedido a partir de los productos agregados al carrito. |
...
La siguiente tabla muestra la relación existente entre las historias de usuario y los requisitos funcionales identificados.
